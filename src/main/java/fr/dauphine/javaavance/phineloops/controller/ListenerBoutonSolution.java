...
// Classe ListenerBoutonSolution permettant de capturer les événements de la souris sur le bouton "Solution"
public class ListenerBoutonSolution extends ListenerBouton {

        // Constructeur de la classe ListenerBoutonSolution
	public ListenerBoutonSolution(Monde m, AffichageMonde am, JFrame f) {
		super(m, am, f);
	}
	...
	public void mousePressed(MouseEvent e) {
                ...
                // Résolution de la grille m
		m.solve(1);
                
                // Retrait de l'ancien composant AffichageMonde
		f.remove(am);
                
                // Création du nouveau composant AffichageMonde avec la grille résolue
